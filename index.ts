...
export default class MultiGethRpc {
   ...
   */
  eth_getBlockByHash(blockHash: IBlockHash, includeTransactions: IIncludeTransactions): Promise<TBlock> {
   ...
   */
  eth_getBlockByNumber(blockNumber: TBlockNumber, includeTransactions: IIncludeTransactions): Promise<TBlock> {
    const params = Array.from(arguments);
   ...
   * Gets a block for a given number
   */
  eth_blockNumber(): Promise<IBlockNumber> {
    const params = Array.from(arguments);
   ...
   */
  eth_getStorageAt(address: IAddress, key: IKey, blockNumber: TBlockNumber): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getTransactionCount(address: IAddress, blockNumber: TBlockNumber): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   * Returns the information about a transaction requested by transaction hash.
   */
  eth_getTransactionByHash(transactionHash: ITransactionHash): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getTransactionByBlockHashAndIndex(blockHash: IBlockHash, index: IIndex): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   * Returns the information about a transaction requested by the block hash and index of which it was mined.
   */
  eth_getTransactionByBlockNumberAndIndex(blockNumber: TBlockNumber, index: IIndex): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getTransactionReceipt(transactionHash: ITransactionHash): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getUncleByBlockHashAndIndex(blockHash: IBlockHash, index: IIndex): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   * Returns information about a uncle of a block by hash and uncle index position.
   */
  eth_getUncleByBlockNumberAndIndex(blockNumber: TBlockNumber, index: IIndex): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_newFilter(filter: TFilter): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_newBlockFilter(): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_newPendingTransactionFilter(): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_uninstallFilter(filterId: IFilterId): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getFilterChanges(filterId: IFilterId): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getFilterLogs(filterId: IFilterId): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getLogs(filter: TFilter): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_submitWork(nonce: INonce, powHash: IPowHash, mixHash: IMixHash): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   * Returns an array of all logs matching a given filter object.
   */
  eth_submitHashrate(hashRate: IHashRate, id: IId): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getProof(address: IAddress, storageKeys: TStorageKeys, blockNumber: TBlockNumber): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getCode(address: IAddress, blockNumber: TBlockNumber): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getBalance(address: IAddress, blockNumber: TBlockNumber): Promise<IBROKEN> {
    const params = Array.from(arguments);
...
' + len(message) + message))).
   */
  eth_sign(address: IAddress, BROKEN: IBROKEN): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_protocolVersion(): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_blockTransactionCountByHash(blockHash: IBlockHash): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_blockTransactionCountByNumber(blockNumber: TBlockNumber): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getUncleCountByBlockHash(blockHash: IBlockHash): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getUncleCountByBlockNumber(blockNumber: TBlockNumber): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_sendTransaction(transaction: TTransaction): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_sendRawTransaction(BROKEN: IBROKEN): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_call(transaction: TTransaction): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_estimateGas(transaction: TTransaction): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_getCompilers(): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_compileSolidity(code: ICode): Promise<TBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_compileLLL(code: ICode): Promise<IBROKEN> {
    const params = Array.from(arguments);
   ...
   */
  eth_compileSerpent(code: ICode): Promise<IBROKEN> {
    const params = Array.from(arguments);
