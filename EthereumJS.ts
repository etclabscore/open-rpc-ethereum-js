...
export type IIncludeTransactions = boolean;
 ...
 */
export type IBROKEN = string;
export interface TBROKEN {
  [k: string]: any;
}
/**
 * Keccak 256 Hash of the RLP encoding of a transaction
 ...
 */
export type IFilterId = string;
/**
 * A number only to be used once
 */
export type INonce = string;
/**
 * Current block header PoW hash.
 */
export type IPowHash = string;
/**
 * The mix digest.
 */
export type IMixHash = string;
/**
 * Hex representation of a 256 bit unit of data
 */
export type IHashRate = string;
/**
 * Hex representation of a 256 bit unit of data
 */
...
export default class EthereumJS {
  rpc: jayson.Client;
  methods: Array<any>;
  validators: any;
   ...
   */
  eth_getBlockByHash(blockHash: IBlockHash, includeTransactions: IIncludeTransactions): jayson.JSONRPCRequest {
   ...
   */
  eth_getBlockByNumber(blockNumber: TBlockNumber, includeTransactions: IIncludeTransactions): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   * Gets a block for a given number
   */
  eth_blockNumber(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getStorageAt(address: IAddress, key: IKey, blockNumber: TBlockNumber): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getTransactionCount(address: IAddress, blockNumber: TBlockNumber): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   * Returns the information about a transaction requested by transaction hash.
   */
  eth_getTransactionByHash(transactionHash: ITransactionHash): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getTransactionByBlockHashAndIndex(blockHash: IBlockHash, index: IIndex): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   * Returns the information about a transaction requested by the block hash and index of which it was mined.
   */
  eth_getTransactionByBlockNumberAndIndex(blockNumber: TBlockNumber, index: IIndex): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getTransactionReceipt(transactionHash: ITransactionHash): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getUncleByBlockHashAndIndex(blockHash: IBlockHash, index: IIndex): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   * Returns information about a uncle of a block by hash and uncle index position.
   */
  eth_getUncleByBlockNumberAndIndex(blockNumber: TBlockNumber, index: IIndex): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_newFilter(filter: IFilter): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_newBlockFilter(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_newPendingTransactionFilter(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_uninstallFilter(filterId: IFilterId): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getFilterChanges(filterId: IFilterId): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getFilterLogs(filterId: IFilterId): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getLogs(filter: IFilter): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getWork(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_submitWork(nonce: INonce, powHash: IPowHash, mixHash: IMixHash): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   * Returns an array of all logs matching a given filter object.
   */
  eth_submitHashrate(hashRate: IHashRate, id: IId): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getProof(address: IAddress, storageKeys: TStorageKeys, blockNumber: TBlockNumber): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getCode(address: IAddress, blockNumber: TBlockNumber): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getBalance(address: IAddress, blockNumber: TBlockNumber): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
...
' + len(message) + message))).
   */
  eth_sign(address: IAddress, BROKEN: IBROKEN): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_account(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_gasPrice(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_hashrate(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_mining(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_coinbase(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_protocolVersion(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_blockTransactionCountByHash(blockHash: IBlockHash): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_blockTransactionCountByNumber(blockNumber: TBlockNumber): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getUncleCountByBlockHash(blockHash: IBlockHash): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getUncleCountByBlockNumber(blockNumber: TBlockNumber): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_sendTransaction(transaction: ITransaction): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_sendRawTransaction(BROKEN: IBROKEN): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_call(transaction: ITransaction): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_estimateGas(transaction: ITransaction): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_syncing(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_getCompilers(): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_compileSolidity(code: ICode): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_compileLLL(code: ICode): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
   ...
   */
  eth_compileSerpent(code: ICode): jayson.JSONRPCRequest {
    const params = Array.from(arguments);
